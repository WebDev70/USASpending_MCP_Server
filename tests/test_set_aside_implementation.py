...
response1 = httpx.post(f"{BASE_URL}/search/spending_by_award/", json=payload1, timeout=30)
...
for agency_name in agencies:
    ...
    response2 = httpx.post(f"{BASE_URL}/search/spending_by_award/", json=payload2, timeout=30)
...
response3 = httpx.post(f"{BASE_URL}/search/spending_by_award/", json=payload3, timeout=30)
...
response4 = httpx.post(f"{BASE_URL}/search/spending_by_award/", json=payload4, timeout=30)
...
response5 = httpx.post(f"{BASE_URL}/search/spending_by_award/", json=payload5, timeout=30)
